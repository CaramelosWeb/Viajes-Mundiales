<?php
	...
	{
    	$mail=$sendMail->newEmail("","",$_POST['emailDestination'],$_POST['emailName']." 
		".$_POST['emailLastName'],$_POST['emailSubject'],$_POST['emailBody']);
		if($mail===true){
			header("location: ../index.php?page=new_email&success=true&folder={$_GET['folder']}&email={$_POST
				['emailDestination']}&name={$_POST['emailName']}&last_name={$_POST['emailLastName']}");
		}else{
			header("location: ../index.php?page=new_email&error=true&folder={$_GET['folder']}&email={$_POST
			['emailDestination']}&name={$_POST['emailName']}&last_name={$_POST['emailLastName']}&error_message={$mail}");
		}
	}
